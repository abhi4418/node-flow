...
function CropImageNodeComponent({ id, data }: NodeProps) {
  ...
  return (
    <>
      <Handle type="target" position={Position.Left} id="image-input" isConnectable={true} />
      ...
      <BaseNode id={id} title="Crop Image" icon={<Crop className="h-4 w-4" />}>
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="space-y-1">
              <Label htmlFor={`x-${id}`} className="text-xs">X Offset (%)</Label>
              <Input
                id={`x-${id}`}
                type="number"
                min="0"
            ...
            <div className="space-y-1">
              <Label htmlFor={`y-${id}`} className="text-xs">Y Offset (%)</Label>
              <Input
                id={`y-${id}`}
                type="number"
                min="0"
