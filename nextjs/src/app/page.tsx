      ...
      <main className="container mx-auto px-4 py-8">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <h2 className="mt-4 text-xl font-semibold text-foreground">No workflows yet</h2>
            <p className="mt-2 text-muted-foreground">Create your first workflow to get started</p>
